            ...
            if(data.account_l){
                ...
                if(data.status == "success"){
                    ...
                    if(data.msg=='no_active'){
                        ...
                        $jsLoginTips.html("User or password wrong，please re-submit!").show();
                    }
                }
            }
        },
	...
	$('#jsSenEmailAgin').on('click', function(e){
        ...
        $.ajax({
            ...
            data: {username:zyUname},
             success: function(data){
                 zy_str="You verify email is been send.";
                 //console.log(data)
                 if(data)
                    zy_Countdown();
             },
            error:function(){
                zy_str="Fail to send verify email!";
            }
